...
async def main(config: CodebornConfig) -> None:
    ...
    async with db(config.database):
        from codeborn_engine.commands.army import router as army_router  # import after logger init
